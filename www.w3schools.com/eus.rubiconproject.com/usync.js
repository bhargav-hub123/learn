var comments = 'User-Sync: generated: 2022-06-09 12:29:26 PDT';
var rtb_sync = {
    "reset_rate": 100,
    "ttl": 14,
    "sample": 100,
    ...
    "pixel_sets": {
        "rtb": {
            ...
            "pixels": {
                ...
                "1197": {
                    "img": "http:\/\/sync.tidaltv.com\/GenericUserSync.ashx?dpid=695",
                    "secure": {
                        "img": "https:\/\/sync.tidaltv.com\/GenericUserSync.ashx?dpid=695"
                    },
                    "partner": "videology"
                },
                "1512": {
                ...
                "1902": {
                    "ttl": 2,
                    "img": "http:\/\/cms.quantserve.com\/pixel\/p-e4m3Yko6bFYVc.gif?idmatch=0",
                    "secure": {
                ...
                "1986": {
                    "ttl": 1,
                    "img": "http:\/\/ib.adnxs.com\/getuidnb?http%3A%2F%2Fpixel.rubiconproject.com%2Ftap.php%3Fv%3D4894%26nid%3D1986%26put%3D$UID%26expires%3D30",
                    "secure": {
                ...
                "2046": {
                    "ttl": 7,
                    "img": "http:\/\/token.rubiconproject.com\/token?pid=2046&pt=n&a=1",
                    "secure": {
                ...
                "2132": {
                    "priority": 5,
                    "img": "http:\/\/um.simpli.fi\/rb_match",
                    "secure": {
                ...
                "2135": {
                    "img": "http:\/\/d5p.de17a.com\/cookies\/rubicon",
                    "secure": {
                ...
                "2249": {
                    "ttl": 1,
                    "img": "http:\/\/cm.g.doubleclick.net\/pixel?google_nid=rubicon&google_cm&google_sc",
                    "priority": 1,
                    "secure": {
                ...
                "2249-DV360-Hosted": {
                    "priority": 1,
                    "ttl": 7,
                    "img": "http:\/\/token.rubiconproject.com\/token?pid=2249&pt=n",
                    "secure": {
                ...
                "2307": {
                    "img": "http:\/\/match.adsrvr.org\/track\/cmf\/rubicon",
                    "priority": 1,
                    "secure": {
                ...
                "2313": {
                    "img": "http:\/\/rbp.mxptint.net\/sn.ashx",
                    "priority": 10,
                    "secure": {
                        "img": "https:\/\/rbp.mxptint.net\/sn.ashx"
                    },
                    "partner": "max-point-us-sync",
                    "country": ["us", "ca"]
                },
                "2395": {
                    "img": "http:\/\/px.owneriq.net\/erb",
                    "region": ["na"],
                    "secure": {
                        "img": "https:\/\/px.owneriq.net\/erb"
                    },
                    "partner": "owner-iq"
                },
                "2494": {
                    "img": "http:\/\/um2.eqads.com\/um\/rc",
                    "region": ["na"],
                    "secure": {
                        "img": "https:\/\/um2.eqads.com:443\/um\/rc"
                    },
                    "partner": "eq-ads"
                },
                "2528": {
                    "img": "http:\/\/sync.intentiq.com\/profiles_engine\/ProfilesEngineServlet?at=20&mi=10&dpi=54",
                    "secure": {
                ...
                "2596": {
                    "ttl": 7,
                    "priority": 10,
                    "img": "http:\/\/p.rfihub.com\/cm?in=1&pub=64",
                    "secure": {
                ...
                "2650": {
                    "img": "http:\/\/match.adsby.bidtheatre.com\/rubiconmatch",
                    "secure": {
                ...
                "2731": {
                    "img": "http:\/\/cm.ctnsnet.com\/int\/cm?exc=2&redir=http%3A%2F%2Fpixel.rubiconproject.com%2Ftap.php%3Fv%3D14965%26nid%3D2731%26put%3D%5Buser_id%5D",
                    "secure": {
                ...
                "2760": {
                    "img": "http:\/\/x.bidswitch.net\/sync?ssp=rubicon",
                    "secure": {
                ...
                "2861": {
                    "priority": 5,
                    "img": "http:\/\/sync.ipredictive.com\/d\/sync\/cookie\/generic?http:\/\/pixel.rubiconproject.com\/tap.php?v=17149&nid=2861&put=${ADELPHIC_CUID}&expires=30",
                    "secure": {
                ...
                "2974": {
                    "ttl": 7,
                    "img": "http:\/\/token.rubiconproject.com\/token?pid=2974&pt=n&a=1",
                    "priority": 1,
                    "secure": {
                ...
                "3632": {
                    "img": "http:\/\/rcp.c.appier.net\/rbcm",
                    "secure": {
                ...
                "3664": {
                    "img": "http:\/\/bttrack.com\/pixel\/cookiesync?source=c91bfcce-bb43-46f7-b14e-567c0a4332b3",
                    "secure": {
                ...
                "3822": {
                    "img": "http:\/\/dsp.adfarm1.adition.com\/cookie\/?ssp=7",
                    "secure": {
                ...
                "3840": {
                    "img": "https:\/\/sync.extend.tv\/r.gif?exchange=rubicon",
                    "secure": {
                        "img": "https:\/\/sync.extend.tv\/r.gif?exchange=rubicon"
                    },
                    "partner": "zypmedia"
                ...
                "3856": {
                    "img": "http:\/\/a.tribalfusion.com\/i.match?p=b10&u={rubicon_user_token}&redirect=http%3A\/\/pixel.rubiconproject.com\/tap.php%3Fv%3D111756%26nid%3D3856%26put%3D%24TF_USER_ID_ENC%24%26expires%3D180",
                    "secure": {
                ...
                "3956": {
                    "img": "https:\/\/sync.adotmob.com\/cookie\/rubicon",
                    "secure": {
                        "img": "https:\/\/sync.adotmob.com\/cookie\/rubicon"
                    },
                    "partner": "AdotMob"
                ...
                "3992": {
                    "img": "http:\/\/b1sync.zemanta.com\/usersync\/rubicon\/",
                    "secure": {
                ...
                "4016": {
                    "img": "https:\/\/cr-p16.ladsp.jp\/cookiesender\/16",
                    "secure": {
                        "img": "https:\/\/cr-p16.ladsp.jp\/cookiesender\/16"
                    },
                    "partner": "so-netmedia",
                ...
                "4032": {
                    "img": "http:\/\/cm.adgrx.com\/bridge?AG_SETCOOKIE&AG_PID=rubicon",
                    "secure": {
                ...
                "4112": {
                    "img": "http:\/\/sync.1rx.io\/usersync2\/rubicon",
                    "secure": {
                ...
                "4114": {
                    "img": "http:\/\/match.prod.bidr.io\/cookie-sync\/rp?bee_sync_partners=rp",
                    "secure": {
                ...
                "4604": {
                    "img": "http:\/\/api.primecaster.net\/adlogue\/api\/sync\/rubicon",
                    "secure": {
                ...
                "4804": {
                    "img": "https:\/\/gu.dyntrk.com\/adx\/rbcn\/us.php?dynk=r1b32c0n",
                    "secure": {
                        "img": "https:\/\/gu.dyntrk.com\/adx\/rbcn\/us.php?dynk=r1b32c0n"
                    },
                    "partner": "dynadmic"
                ...
                "5120": {
                    "img": "http:\/\/bh.contextweb.com\/bh\/rtset?pid=560687&ev=1&rurl=http%3A%2F%2Fpixel.rubiconproject.com%2Ftap.php%3Fv%3D390200%26nid%3D5120%26put%3D%25%25VGUID%25%25",
                    "secure": {
                ...
                "5466": {
                    "img": "https:\/\/ib.adnxs.com\/getuid?https:\/\/pixel.rubiconproject.com\/tap.php?v=564534&nid=5466&put=$UID",
                    "secure": {
                        "img": "https:\/\/ib.adnxs.com\/getuid?https:\/\/pixel.rubiconproject.com\/tap.php?v=564534&nid=5466&put=$UID"
                    },
                    "partner": "playground-xyz"
                },
                "5498": {
                ...
                "5516": {
                    "img": "https:\/\/ad.mrtnsvr.com\/sync\/magnite",
                    "secure": {
                        "img": "https:\/\/ad.mrtnsvr.com\/sync\/magnite"
                    },
                    "partner": "martin.ai"
                ...
                "w55c": {
                    ...
                    "priority": 5,
                    "ttl": 7,
                    "img": "http:\/\/i.w55c.net\/ping_match.gif?ei=RUBICON&rurl=http%3A%2F%2Fpixel.rubiconproject.com%2Ftap.php%3Fv%3D4210%26nid%3D1523%26put%3D_wfivefivec_%26expires%3D30",
                    "secure": {
                ...
                "1523ext": {
                    "iframe": "http:\/\/cti.w55c.net\/ct\/cms-2c-rubicon.html",
                    "secure": {
                ...
                "1197ext": {
                    "img": "http:\/\/sync.tidaltv.com\/genericusersync.ashx?dpid=rubicon",
                    "secure": {
                        "img": "https:\/\/sync.tidaltv.com\/genericusersync.ashx?dpid=rubicon"
                    },
                    "partner": "videology"
                },
                "brx": {
    ...
    "modified": 1654795046,
    "dateModified": "2022-06-09 10:17:26 PDT"
};

function isSellerSync() {
    return !!retrieveQueryParams().p
}

function shouldSkipBuyerSync() {
    return skipBuyerSync || !1 === skipBuyerSync ? skipBuyerSync : Math.floor(100 * Math.random()) < Number(rtb_sync.sample) ? alreadyRanOnPage() ? (log("skipping buyer sync cause already ran"), skipBuyerSync = !0) : skipBuyerSync = !1 : (log("skipping buyer sync due to sampling"), skipBuyerSync = !0)
}
...
function getPartnerFcap(a, b) {
    return b ? (a[b] = a[b] || createNewFcap(), a[b]) : null
}
...
function oz_onPixelsLoaded(a) {
    if (a && a.pixels)
        for (var b, c = 0; c < a.pixels.length; c++)(b = a.pixels[c].url) && 0 == b.indexOf("http") && ((new Image).src = appendConsentQS(b))
}

function getReferrer() {
    var a, b = document.referrer;
    return b && b.length > 0 && (a = escape(b)), a
}
...
function countCookies(a) {
    for (var b = document.cookie.split(";"), c = 0, d = 0; d < b.length; d++) {
        var e = b[d];
        e = trim_whitespace(e), a ? 0 == e.indexOf(a) && c++ : c++
    }
    return c
}
...
function addScript(a, b) {
    var c = '<script type="text/javascript" SRC="' + a + '" async><\/script>';
    document.write(c)
}

function retrieveQueryParams() {
    for (var a, b = window.location.search.substring(1), c = b.split("&"), d = {}, e = 0; e < c.length; e++) a = c[e].split("="), a[0] && (d[decodeURIComponent(a[0])] = decodeURIComponent(a[1] || ""));
    return d
}
...
function getRegion(a) {
    if (a)
        for (var b in regionCountries)
            if (regionCountries.hasOwnProperty(b) && regionCountries[b].indexOf(a) > -1) return b;
    return ""
}

function getAllowList() {
    try {
        var a = "emily_allowlist",
            b = ssGet(a);
        if (!b) return;
        return b = b.split("-"), (new Date).getTime() - Number(b[0]) > 45e3 ? void ssRemove(a) : JSON.parse(b[1])
    } catch (e) {
        return void log("allowlist error:", e)
    }
}

function getQueryStringParam(a) {
    if (!a || -1 === (window.location.search || "").indexOf(a)) return null;
    var b = new RegExp("[?&]" + a + "((=([^&]*))|(&|$))"),
        c = b.exec(window.location.search);
    return !c || c.length < 5 ? null : decodeURIComponent(c[3] || "")
}
...
function saveExpiration(a) {
    ...
    for (name in a) {
        var c = a[name];
        b += name + "=", b += c.created, b += "&"
    }
    lsSet("pux", b)
}

function is_expired(a, b) {
    return !b || (a = Number(a), !((new Date).getTime() / 36e5 - new Date(2010, 0, 1, 0, 0, 0, 0).getTime() / 36e5 < new Number(b.created) + 24 * a))
}

function shouldFirePixel(a) {
    var b = expiration_info[a.nid];
    if (b && !is_expired(a.info.ttl || a.context.ttl || rtb_sync.ttl, b)) return !1;
    var c = 0 == a.info.sample ? a.info.sample : a.info.sample || a.context.sample || rtb_sync.pixel_sample || 0;
    return c = Number(c), Math.floor(100 * Math.random()) < c
}

function firePixel(a) {
    var b = Math.floor((new Date).getTime() / 36e5),
        c = new Date(2010, 0, 1, 0, 0, 0, 0).getTime() / 36e5;
    ...
    if (d) {
        ...
        if (d.script) {
            var f = d.script;
            "rp" == a.nid && e && (f = appendQSParams(f, "rf=" + e))
        }
        d.img && setTimeout(function() {
            (new Image).src = appendConsentQS(d.img)
        }, 100), d.iframe && document.write("<iframe src='" + appendConsentQS(d.iframe) + "' width='1' height='1' frameborder='0'></iframe>"), d.script && addScript(appendConsentQS(f))
    }
}
...
function doPixels() {
    var a = !0,
        b = new Array,
        c = new Array;
    if (!readCookie("khaos")) return void log("skipping syncs cause no khaos");
    expiration_info = loadExpiration();
    var d = getAllowList();
    d && log('restricting to the following "allowlist" pixels:', d);
    for (var e in rtb_pixel_set) {
        var f = rtb_pixel_set[e],
            g = rtb_sync.pixel_sets[f];
        if (g)
            for (l in g.pixels)
                if (!d || d.indexOf(l) > -1) {
                    var h = g.pixels[l];
                    h.priority = h.priority || g.priority || rtb_sync.priority, isPixelAllowed(h.sample, h.region, request_region, h.country, request_country) && (h.ttl = h.ttl || g.ttl || rtb_sync.ttl, b[b.length] = {
                        pixel_set: f,
                        nid: l,
                        info: h,
                        context: g
    ...
    if (prioritize(b), detectIE()) {
        var i = rtb_sync.max_ie_partners || b.length;
        b.splice(i, b.length - i)
    }
    for (var e in b) {
        var j = b[e];
        is_expired(j.info.ttl, expiration_info[j.nid]) && 0 != j.info.sample && (c[c.length] = j)
    }
    a = 0 == c.length, shuffle(c), prioritize(c);
    var k = rtb_sync.max_pixels || 1;
    for (var e in c) {
        var j = c[e];
        if (shouldFirePixel(j) && (firePixel(j), --k <= 0)) break
    }
    var l = "rubicon",
        h = rtb_sync.notify[l],
        j = {
    ...
    shouldFirePixel(j) && (j.info.img += "?allfired=" + a, j.info.img += "&cookies=" + countCookies(), j.info.img += "&ie=" + (detectIE() ? "true" : "false"), firePixel(j)), saveExpiration(expiration_info)
}

function isPixelAllowed(a, b, c, d, e) {
    if (0 == a) return !1;
    var f = !(!b || !c),
        g = !(!d || !e);
    return !(f || g) || f && (b == c || array_contains(b, c)) || g && (d == e || array_contains(d, e))
}

function getConsentParams(a, b, c) {
    if (!1 === c) return b;
    var d = b || {};
    return a && "object" == typeof a && (a.uspString || (d.gdpr_consent = a.tcString || a.consentData), void 0 !== a.gdprApplies && (d.gdpr = a.gdprApplies ? 1 : 0), a.uspString && (d.us_privacy = encodeURIComponent(a.uspString))), "string" == typeof a && (d.gdpr_consent = a), d
}
...
function getConsent(a) {
    function b(a, b, c) {
        0 !== f.length && f.includes(a) && (f = f.filter(function(b) {
            return b !== a
        }), consentParams = getConsentParams(c, consentParams, b), 0 === f.length && k())
    }
    if (!(consentParams = getConsentQSParams()) || void 0 === consentParams.gdpr) var c = getConsentWindowFor("__tcfapiLocator"),
        d = c ? null : getConsentWindowFor("__cmpLocator");
    if (!consentParams || !consentParams.us_privacy) var e = getConsentWindowFor("__uspapiLocator");
    if (!c && !d && !e) return void a();
    var f = [],
        g = !1,
        h = "us-" + Math.random(),
        i = "us-" + Math.random(),
    ...
    if (c ? (f.push("tcf"), c.postMessage({
            __tcfapiCall: {
                callId: j,
                command: "addEventListener",
                version: 2
            }
        }, "*")) : d && (f.push("cmp"), d.postMessage({
            __cmpCall: {
                callId: h,
                command: "getConsentData",
                parameter: null
            }
        }, "*")), e && (f.push("usp"), e.postMessage({
            __uspapiCall: {
                callId: i,
                command: "getUSPData",
                version: 1
            ...
            try {
                if (a && a.data) {
                    var c = "string" == typeof a.data ? JSON.parse(a.data) : a.data,
                        ...
                        e = c.__uspapiReturn,
                        f = c.__tcfapiReturn;
                    f && f.callId === j && f.returnValue && ("tcloaded" === f.returnValue.eventStatus || "useractioncomplete" === f.returnValue.eventStatus) ? (clearTimeout(m), b("tcf", f.success, f.returnValue)) : d && d.callId === h && (clearTimeout(n), b("cmp", d.success, d.returnValue)), e && e.callId === i && (clearTimeout(l), b("usp", e.success, e.returnValue))
                }
            } catch (e) {}
        }), e) var l = setTimeout(function() {
        b("usp", !1)
    }, 100);
    if (c) var m = setTimeout(function() {
        b("tcf", !1)
    }, 500);
    else if (d) var n = setTimeout(function() {
        b("cmp", !1)
    }, 500)
}
...
function checkCookies() {
    if (!document.cookie) {
        if (setCookie("cd", "false"), !document.cookie) return log("will not request khaos cause cannot set cookies"), void runSyncs();
        deleteCookie("cd")
    }
    if (readCookie("khaos")) runSyncs();
    else {
        log("khaos not set, making request for khaos");
        ...
        d.onload = function() {
            runSyncs()
        }, d.src = "https://token.rubiconproject.com/khaos.jpg?" + a + c
    }
}
...
function alreadyRanOnPage() {
    ...
    if (!navigator.cookieEnabled) return log("The browser does not support cookies"), !1;
    try {
        var b = "emilyRan";
        window.addEventListener ? window.addEventListener("unload", a, !1) : window.attachEvent && window.attachEvent("onunload", a);
        var c = ssGet(b);
        if ((c = c && Number(c)) && (new Date).getTime() - c < 3e5) return !0;
        ssSet(b, (new Date).getTime())
    } catch (e) {
        return log("failed checking if already ran:", e), !1
    }
    return !1
}
...
function sellerSync(a, b, c, d) {
    ...
    var e = {
        ...
        f = "";
    a.endpoint in e && (f = "-" + a.endpoint);
    var g = ["https://pixel", f, ".rubiconproject.com/exchange/sync.php?p=", b].join("");
...
function initiateSellerSync(a) {
    if (!a) return !1;
    var b = getPartnerFcaps("fcap");
    removeExpiredPartners(b);
...
function runSyncs() {
    ...
    if (a || checkSampling("runSyncs without khaos cookie")) {
        checkKhaosMatchesPrevious(a);
        var b = retrieveQueryParams(),
            c = b.p;
        if (c) {
            log("doing seller sync");
            var d = lsGet("khaos");
            c.split(",").filter(function(a) {
                return initiateSellerSync(a)
            }).forEach(function(c) {
                return sellerSync(b, c, consentParams, a || d)
            })
        }
        if (!a) return void log("skipping buyer sync cause no khaos");
        shouldSkipBuyerSync() || (log("doing buyer sync"), doPixels())
    }
}

function checkKhaosMatchesPrevious(a) {
    if (a) {
        var b = lsGet("khaos");
...
function checkSampling(a) {
    var b = Number(rtb_sync.reset_rate) || 100,
        c = lsGet("sample_number");
    return null === c && (c = Math.floor(100 * Math.random()), lsSet("sample_number", c)), Number(c) < b ? (log(a, ": running"), !0) : (log(a, ": Not running due to sampling"), !1)
}

function startSync() {
    return log("starting"), !(shouldSkipBuyerSync() && !isSellerSync()) && (getConsent(checkCookies), !0)
}
...
function lsGet(a) {
    try {
        ...
        return console.log("LS: failed to get:", a), null
    }
}
...
function lsSet(a, b) {
    try {
        ...
        console.log("LS: failed to set:", a, b)
    }
}
...
function lsRemove(a) {
    try {
        ...
        console.log("LS: failed to remove:", a)
    }
}
...
function ssGet(a) {
    try {
        ...
        return console.log("SS: failed to get:", a), null
    }
}
...
function ssSet(a, b) {
    try {
        ...
        console.log("SS: failed to set:", a, b)
    }
}
...
function ssRemove(a) {
    try {
        ...
        console.log("SS: failed to remove:", a)
    }
}

function log() {
    try {
        if ("true" === readCookie("emily_debug") || "true" === lsGet("emily_debug")) {
            if (!logPrefix) {
                var a = "" + Math.random();
...
var skipBuyerSync, consentParams, regionCountries = {
